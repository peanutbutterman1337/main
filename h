                    ...
                    for i,v in pairs(options) do
                        ...
                        item.MouseButton1Click:Connect(function()
                            ...
                            --[[for i2,v2 in pairs(list:GetChildren()) do
                                if v2.Name == "title" then
                                    print(title_5.." title_5")
                                 if v2.Text == Selected then
                                    print(Selected.." Selected")
                                     --v2.TextColor3 = color
                                 else
                                    print(Selected.." Else Selected")
                        ...
                        for i3,v3 in pairs(combobox:GetChildren())do  
                            if v3.Name:find("title") then  
                            for i2,v2 in pairs(item:GetChildren()) do
                                if (v2.Name:find("title") and v2.Text == v3.Text) then
                                    print("true")
                                    v2.TextColor3 = color
                                    else
                                        v2.TextColor3 = Color3.fromRGB(255, 255, 255)
                                        v2.UIGradient.Enabled = false
                                        print("false")
                                end
