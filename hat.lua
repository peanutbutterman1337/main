...
function DrawingRender:DrawBlock()
	...
	local MainConn = game:GetService("RunService").Heartbeat:Connect(function()
        ...
        UpdateTop.Visible = Functions.Transparency
        ...
        UpdateBottom.Visible = Functions.Transparency
        ...
        UpdateLeft.Visible = Functions.Transparency
        ...
        UpdateRight.Visible = Functions.Transparency
        ...
        UpdateFront.Visible = Functions.Transparency
		local VertexBack = {
			Vector3.new(VertexBaseB.X,VertexBaseA.Y,VertexBaseB.Z),
			Vector3.new(VertexBaseA.X,VertexBaseA.Y,VertexBaseB.Z),
			Vector3.new(VertexBaseA.X,VertexBaseB.Y,VertexBaseB.Z),
        ...
        UpdateBack.Visible = Functions.Transparency
