...
function Library:CreateWindow(title, color)
    ...
    color = color and Library:GetColor(color) or Color3.fromRGB(135, 191, 52)
    ...
    local title_yesz = Instance.new("TextLabel")
	...
	fakeButton.Parent = BracketV2
	fakeButton.Name = 'FakeButton'
	fakeButton.Modal = true
	fakeButton.Transparency = 1
	fakeButton.Text = ''

    Gradientbar.Name = "Gradient bar"
    Gradientbar.Parent = core
    Gradientbar.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    Gradientbar.Position = UDim2.new(0, 0, 9.99999975e-05, 0)
    Gradientbar.Size = UDim2.new(0, 540, 0, 1)

    UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(59, 129, 155)), ColorSequenceKeypoint.new(0.47, Color3.fromRGB(139, 67, 143)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(147, 159, 77))}
    ...
    title_18.Visible = false
  
    title_yesz.Name = "titlee"
    title_yesz.Parent = outlinecore
    title_yesz.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    title_yesz.BackgroundTransparency = 1.000
    ...
    title_yesz.TextXAlignment = Enum.TextXAlignment.Left
    title_yesz.Visible = false
    ...
    function WinTypes:UpdateColor(newcolor)
        ...
        for i,v in pairs(BracketV2:GetDescendants()) do
            if v:IsA("Frame") and v.Name == "bar" then
                v.BackgroundColor3 = Color3.fromRGB(newcolor)
            end
            if v:IsA("Frame") and v.Name == "checkbox" and v.BackgroundColor3 ~= Color3.fromRGB(60,60,60) then
                v.BackgroundColor3 = Color3.fromRGB(newcolor)
            end
            if v:IsA("Frame") and v.Name == "combobox" then
                for i2,v2 in pairs(v:GetDescendants()) do
                    if v2.Name == "title" and v2.Parent.Name == "item" then
                        if v2.TextColor3 ~= Color3.fromRGB(255,255,255) then
                            v2.TextColor3 = Color3.fromRGB(newcolor)
                        end
                    end
                end
            end
    ...
    function WinTypes:CreateTab(name, players)
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateToggle(name, callback)
                ...
                checkbox.Size = UDim2.new(0, 7, 0, 7)
                checkbox.ZIndex = 0
                ...
                title_3.Position = UDim2.new(2, 0, 0, -4)
                ...
                function ToggleTypes:CreateKeyBind(def, callback)
                    ...
                    bindtext.Position = UDim2.new(13.5, 70, 0, -4)
            ...
            function GroupTypes:RemoveSlider(text, idx, val)
                

                for _,v in pairs(container_2:GetChildren()) do
            ...
            function GroupTypes:CreateSlider(name, min, max, def, callback)
                ...
                slider.Size = UDim2.new(0, 234, 0, 8)
            ...
            function GroupTypes:CreateSlider2(name, min, max, def, text, Y,callback)
                name = name or "New Slider"
                min = min or 0
                max = max or 100
                def = def or 50
                ...
                title_15.BackgroundTransparency = 1.000
                title_15.Position = UDim2.new(0, 10, 0, 51)
                title_15.Size = UDim2.new(0, 234, 0, 25)
                title_15.ZIndex = 0
                title_15.Font = Enum.Font.SourceSans
                title_15.Text = name
                title_15.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                slider.BorderColor3 = Color3.fromRGB(8, 8, 8)
                slider.Position = UDim2.new(0, 0, 0, 18)
                slider.Size = UDim2.new(0, 234, 0, 6)
                
                UIGradient_15.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(181, 181, 181)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(120, 120, 120))}
                UIGradient_15.Rotation = 90
                UIGradient_15.Parent = slider
            ...
            function GroupTypes:CreateSlider3(name, min, max, def, text, Y, Z, align, callback)
                name = name or "New Slider"
                min = min or 0
                max = max or 100
                def = def or 50
                ...
                -- Slider Code
                bar.Size = UDim2.new(def / max, 0, 1, 0)
                if s == Z and Z ~= nil then
                value.Text = tostring(text)
                value.TextXAlignment = align
                else
                    value.Text = def .. Y
                    value.TextXAlignment = 1
                end
                ...
                function SliderTypes:SetValue(s)
                    ...
                    Value = s
                    bar.Size = UDim2.new(Value / max, 0, 1, 0)
                    if Value == Z and Z ~= nil then
                    value.Text = tostring(Z)
                    value.TextXAlignment = align
                    else
                        value.Text = tostring(Value)..Y
                        value.TextXAlignment = 1
            ...
            function GroupTypes:CreateDropdown(name, options, callback)
                ...
                title_15.BackgroundTransparency = 1.000
                title_15.Position = UDim2.new(0, 10, 0, 51)
                title_15.Size = UDim2.new(0, 234, 0, 30)
                title_15.ZIndex = 0
                title_15.Font = Enum.Font.SourceSans
                title_15.Text = name
                title_15.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                combobox.Position = UDim2.new(0, 0, 0, 18)
                combobox.Size = UDim2.new(0, 150, 0, 15)

                ImageLabel.Parent = combobox
                ImageLabel.BackgroundColor3 = Color3.fromRGB(57, 57, 57)
                ImageLabel.BorderColor3 = Color3.fromRGB(21, 21, 21)
                ImageLabel.BackgroundTransparency = 1
                ImageLabel.Position = UDim2.new(0, 127, 0, -7)
                ImageLabel.Size = UDim2.new(0, 28, 0, 28)
                ImageLabel.Image = "rbxasset://textures/ui/Untitled-4 (2).png"
                ...
                UIGradient_3.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(181, 181, 181)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(120, 120, 120))}
                ...
                title_4.Position = UDim2.new(0, 11, 0, -1)
                title_4.Size = UDim2.new(0, 223, 0, 15)
                ...
                UIListLayout_4:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                    list.Size = UDim2.new(0, 150, 0, UIListLayout_4.AbsoluteContentSize.Y)
                end)

                local TweenService = game:GetService("TweenService")
                local Object = combobox:WaitForChild("ImageLabel") 
                ...
                local Tween = TweenService:Create(Object, tweenInfo, {Rotation = 180})
                local Tween2 = TweenService:Create(Object, tweenInfo, {Rotation = 0})
                ...
                main_2.MouseButton1Click:Connect(function()
                    ...
                    tween_toggle = not tween_toggle
                    if tween_toggle then
                        Tween:Play()
                        
                    end
                    if tween_toggle == false then
                        Tween2:Play()
                    end
                    ...
                    for i,v in pairs(list:GetChildren()) do
                        if (v.Name:find("item")) then
                            if (v.Text == Selected) then
                                item.title_5.TextColor3 = color
                                v.UIGradient.Enabled = true
                            else
                                item.title_5.TextColor3 = Color3.fromRGB(255, 255, 255)
                                v.UIGradient.Enabled = false
                            end
                        end
                    end
            ...
            function GroupTypes:CreateDropdown_3(name, options, callback)
                name = name or "Dropdown"
                options = options or {}
                callback = callback or function(o) print(o) end
                ...
                title_15.BackgroundTransparency = 1.000
                title_15.Position = UDim2.new(0, 10, 0, 51)
                title_15.Size = UDim2.new(0, 234, 0, 20)
                title_15.ZIndex = 0
                title_15.Font = Enum.Font.SourceSans
                title_15.Text = name
                title_15.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                combobox.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
                combobox.BorderColor3 = Color3.fromRGB(8, 8, 8)
                combobox.Position = UDim2.new(0, 0, 0, 2)
                combobox.Size = UDim2.new(0, 150, 0, 15)
            ...
            function GroupTypes:CreateDropdown_2(name, options, callback)
                name = name or "Dropdown"
                options = options or {}
                callback = callback or function(o) print(o) end
                ...
                tween_toggle_2 = false
                -- Dropdown Code
                main_2.MouseButton1Click:Connect(function()
                    title_15.ZIndex = 9
                    list.Visible = not list.Visible
                    tween_toggle_2 = not tween_toggle_2
                    if tween_toggle_2 then
                        Tween:Play()
                    end

                    if tween_toggle_2 == false then
                        Tween2:Play()
                    end
            ...
            function GroupTypes:CreateButton(name, callback)
                ...
                UIGradient_17.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(181, 181, 181)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(120, 120, 120))}
                ...
                function GroupTypes:CreateColorPicker2(name, def, text, callback)
                    ...
                    if v:IsA("Frame") then
                        if v.Name == "checkbox" then
                            for _,v2 in pairs(v:GetChildren()) do
                                if v2:IsA("TextLabel") then
                                    if v2.Text == text then
                                    colorpicker.Parent = v
                                    end
                                end
                            end
                        end
                ...
                colorpicker.Position = UDim2.new(0, 216, 1, -9)
                colorpicker.Size = UDim2.new(0, 15, 0, 7)
